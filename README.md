...
------------------------
Desarrollador Backend Java | Arquitecto de Soluciones Técnicas | Apasionado por la Ingeniería de Software
...
### Skills
- Desarrollo backend con Java moderno
- Meta-programación avanzada y desarrollo de frameworks personalizados
- Diseño e implementación de patrones de arquitectura
- Principios SOLID, inversión de control, separación de responsabilidades  

### Proyectos Destacados  
- **CatORM**: Framework ORM personalizado con arquitectura proxy de dos niveles, generación automática de SQL y mapeo objeto-relacional sin dependencias externas
<p align="left">
